...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String PIn = String.valueOf(temp);
        String sql = "select Password from students where RegisterNumber = ?";
        try{
            con = Conn.connect();
            ...
            rs = ps.executeQuery();
            if(rs.next()){
              String POut = rs.getString("Password");
              boolean x = POut.equals(PIn);
              if(x){
                  if(UIn.equalsIgnoreCase("0")){
